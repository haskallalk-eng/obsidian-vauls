...
def main() -> None:
    ...
    make_cut(
        ...
        [
            ...
            [(20, 143), (63, 150), (96, 196), (105, 270), (148, 344), (166, 424), (56, 424), (31, 319), (8, 225)],
            # Hand/fingers wrapped around receiver.
            [(28, 172), (116, 157), (151, 206), (143, 292), (62, 312), (8, 255)],
            # Lower receiver cap.
            [(72, 326), (170, 324), (190, 358), (190, 424), (84, 424), (56, 391)],
        ],
        subtract=[
            # Mascot body/face on the right side of the crop.
            [(129, 0), (190, 0), (190, 314), (151, 314), (119, 264), (118, 170), (128, 118)],
            ...
            [(124, 78), (186, 72), (186, 172), (129, 170), (129, 125)],
            [(160, 286), (190, 292), (190, 322), (170, 318)],
        ],
        low=4,
        high=78,
        feather=0.9,
